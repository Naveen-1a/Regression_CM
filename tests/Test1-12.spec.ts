...
// Import your helper functions (Combined exactly once)
import { 
...
test.describe.serial('CourseMill Complete Flow - Org Creation to Unenrollment', () => {
  ...
  test('CreateOrg - Add Organization validation', async ({ page }) => {
    ...
    // ⏳ BUFFER: Allowing backend database to commit before Test 2 tries to read it
    console.log('⏳ Delaying 3 seconds to ensure backend synchronization...');
  ...
  test('Validate Access Code NSUI Registration', async ({ page }) => {
    ...
    // ⏳ BUFFER: Allowing backend database to commit User data properly
    console.log('⏳ Delaying 3 seconds to ensure User data is synchronized...');
    await page.waitForTimeout(3000);
  });
  ...
  test('Create New Course under Org', async ({ page }) => {
    ...
    // ⏳ BUFFER: Allowing backend to fully assign the user to the course before Test 10 checks it
    console.log('⏳ Delaying 3 seconds to ensure course registration synchronizes...');
    await page.waitForTimeout(3000);
  });
